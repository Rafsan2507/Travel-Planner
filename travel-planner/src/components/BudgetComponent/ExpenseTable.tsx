...
const ExpenseTable = ({planId}: Props) => {
    ...
    useEffect(()=>{
        ...
        dispatch(getTravelsById(planId))
    },[dispatch,planId])
  ...
  return (
    <div>
        <div className='mt-4 ml-4'><AddExpense planId={planId}/></div>
        <div className='flex justify-end mr-4'>
        <div className='p-4 border-2 w-fit border-[#50b3ea]'>Total Spent: ${totalExpense}</div>
        </div>
        <div className='mt-4'>
